...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, max_opacity=0.99, tmin=0.2, light_strength=0):
        ...
        self._normals = torch.empty(0) #lpc    
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': [self._normals], 'lr': training_args.normal_lr, "name": "normals"}, #lpc
    ...
    def save_ply(self, path):
        ...
        normals = self._normals.detach().cpu().numpy() #lpc
    ...
    def load_ply(self, path):
        ...
        normals = np.zeros((xyz.shape[0], 3)) #lpc
        for idx in range(3): 
            normals[:, idx] = np.asarray(plydata.elements[0]["normal_{}".format(idx)]) #lpc
